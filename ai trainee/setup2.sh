#!/usr/bin/env bash
# ╔══════════════════════════════════════════════════════╗
# ║   AI Platform — Files Only (Ollama already installed) ║
# ╚══════════════════════════════════════════════════════╝
...
echo ""
echo "╔══════════════════════════════════════════════════╗"
echo "║   AI Platform — Writing all files now...         ║"
echo "╚══════════════════════════════════════════════════╝"
echo ""

# Ollama is already installed and phi3:mini is already pulled — skip those steps
echo "▶ Ollama already installed, phi3:mini already pulled — skipping."
